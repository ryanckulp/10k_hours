...
RSpec.describe SettingsHelper do
  ...
  context 'project has assets' do
    ...
    it 'should return missing asset strings' do
      ...
      expect(test_class.asset_label(project.banner)).to eq('Banner (1488x2000px) - exists')
    ...
    describe 'asset_dimensions' do
      it 'should return the correct size string' do
        ...
        expect(test_class.asset_dimensions(project.banner.name)).to eq('1488x2000px')
  ...
  context 'project has no assets' do
    ...
    it 'should return missing asset strings' do
      ...
      expect(test_class.asset_label(project.banner)).to eq('Banner (1488x2000px) - missing')
